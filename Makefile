...
check: all
	...
	QSTAR_TEST_QSTAR="$$bin" sh tests/response-file-capabilities.sh; \
	...
	QSTAR_TEST_QSTAR="$$bin" sh tests/local-action-cache.sh; \
...
qstar-dynamic-action-argv-tests: all
	bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" CC="$(CC)" sh tests/dynamic-action-argv.sh

qstar-response-file-capability-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" sh tests/response-file-capabilities.sh
...
qstar-test-resources-results-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" sh tests/test-resources-results.sh

qstar-glp-v2-artifact-contract-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" sh tests/glp-v2-artifact-contract.sh

qstar-glp-v2-backend-parity-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" sh tests/glp-v2-backend-parity.sh
...
qstar-local-action-cache-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" sh tests/local-action-cache.sh
...
qstar-downstream-safe-upgrade-tests: all
	@bin="$(BIN_DIR)/qstar"; \
	case "$$bin" in /*) ;; *) bin="$(CURDIR)/$$bin";; esac; \
	QSTAR_TEST_QSTAR="$$bin" python3 tests/downstream-safe-upgrade.py
