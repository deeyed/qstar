...
- `qstar.objectlib "objc_objects"` owns the generated object source, and
  `qstar.executable`, `qstar.staticlib`, and `qstar.sharedlib` consume that
  object collection through `objects`.
