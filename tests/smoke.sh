...
test "$(cat "$tmp/version-cmd.out")" = "qstar 0.5.0-beta.1" || fail "qstar version drifted"
...
contains "$tmp/lua-authoring.out" "-DQSTAR_VERSION=0.5.0-beta.1"
...
contains "README.md" "v0.5.0-beta.1"
...
contains "README.ko.md" "v0.5.0-beta.1"
...
contains "docs/qstar-v0.5-readiness.md" "status: 0.5 readiness gate"
...
contains "docs/qstar-v0.5-readiness.md" "qstar 0.5.0-beta.1"
...
contains "docs/public-beta-release.md" "qstar-v0.5.0-beta.1-macos-arm64.tar.gz"
contains "docs/public-beta-release.md" "qstar-v0.5.0-beta.1-linux-x86_64.tar.gz"
