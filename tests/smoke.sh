...
test "$(cat "$tmp/version-flag.out")" = "qstar 0.7.11-beta" || fail "qstar --version drifted"
"$qstar" version > "$tmp/version-cmd.out" 2> "$tmp/version-cmd.err"
test "$(cat "$tmp/version-cmd.out")" = "qstar 0.7.11-beta" || fail "qstar version drifted"
...
contains "$tmp/lua-authoring.out" "-DQSTAR_VERSION=0.7.11-beta"
...
contains "README.md" "v0.7.11-beta"
...
contains "README.ko.md" "v0.7.11-beta"
...
contains "docs/releases/v0.7.11-beta.md" "QStar v0.7.11 Beta"
contains "docs/releases/v0.7.11-beta.md" "qstar-v0.7.11-beta-windows-x86_64.zip"
contains "docs/releases/v0.7.11-beta.md" "publish_windows_asset=true"
contains "docs/releases/v0.7.11-beta.md" "Windows official beta asset"
...
contains "docs/daemon-beta-readiness.md" "0.7.11-beta"
...
contains "docs/README.md" "releases/v0.7.11-beta.md"
...
contains "docs/public-beta-release.md" "qstar-v0.7.11-beta-macos-arm64.tar.gz"
contains "docs/public-beta-release.md" "qstar-v0.7.11-beta-linux-x86_64.tar.gz"
contains "docs/public-beta-release.md" "0.7.11-beta"
