...
test "$(cat "$tmp/version-flag.out")" = "qstar 0.4.0" || fail "qstar --version drifted"
"$qstar" version > "$tmp/version-cmd.out" 2> "$tmp/version-cmd.err"
test "$(cat "$tmp/version-cmd.out")" = "qstar 0.4.0" || fail "qstar version drifted"
...
contains "$tmp/lua-authoring.out" "-DQSTAR_VERSION=0.4.0"
...
contains "README.md" "docs/qstar-v0-seal.md"
contains "README.md" "docs/qstar-v0.1-hardening-seal.md"
contains "README.md" "docs/qstar-v0.2-release-candidate-seal.md"
contains "README.md" "qstar-v0.1-release-tests"
contains "README.md" "qstar-v0.2-rc-tests"
...
contains "docs/qstar-v0.4-stella-seal.md" "runtime version: qstar 0.4.0"
...
contains "LICENSE/README.md" "standalone QStar license/notice bundle"
...
contains "README.md" "docs/qstar-v0.4-stella-seal.md"
