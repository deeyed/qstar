...
test "$(cat "$tmp/version-flag.out")" = "qstar 0.7.0-beta" || fail "qstar --version drifted"
"$qstar" version > "$tmp/version-cmd.out" 2> "$tmp/version-cmd.err"
test "$(cat "$tmp/version-cmd.out")" = "qstar 0.7.0-beta" || fail "qstar version drifted"
...
contains "$tmp/lua-authoring.out" "-DQSTAR_VERSION=0.7.0-beta"
...
contains "README.md" "v0.7.0-beta"
...
contains "README.ko.md" "v0.7.0-beta"
...
contains "docs/daemon-beta-readiness.md" "0.7.0-beta"
...
contains "docs/public-beta-release.md" "qstar-v0.7.0-beta-macos-arm64.tar.gz"
contains "docs/public-beta-release.md" "qstar-v0.7.0-beta-linux-x86_64.tar.gz"
contains "docs/public-beta-release.md" "0.7.0-beta"
