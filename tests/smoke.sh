...
cp -R "$project_root/ribon-bootloader-like" "$tmp/project-ribon"
"$qstar" --file "$tmp/project-ribon/qstar.lua" check //:kernel > "$tmp/project-ribon-check.out" 2> "$tmp/project-ribon-check.err"
contains "$tmp/project-ribon-check.out" "target-count 1"
contains "$tmp/project-ribon-check.out" "generated-action-count 1"
contains "$tmp/project-ribon-check.out" "stage-count 2"
"$qstar" --file "$tmp/project-ribon/qstar.lua" dry-run //:kernel > "$tmp/project-ribon-kernel-dry.out" 2> "$tmp/project-ribon-kernel-dry.err"
contains "$tmp/project-ribon-kernel-dry.out" "profile_target arch=aarch64 cpu=cortex-a76 abi=lp64 freestanding=true"
contains "$tmp/project-ribon-kernel-dry.out" "-ffreestanding"
contains "$tmp/project-ribon-kernel-dry.out" "-mgeneral-regs-only"
contains "$tmp/project-ribon-kernel-dry.out" "-D__RIBON_BOOT__=1"
contains "$tmp/project-ribon-kernel-dry.out" "-T"
contains "$tmp/project-ribon-kernel-dry.out" "linker/rpi5-aarch64.ld"
contains "$tmp/project-ribon-kernel-dry.out" "--defsym=__stack_top=0x810000"
"$qstar" --file "$tmp/project-ribon/qstar.lua" build //:kernel --explain-cache > "$tmp/project-ribon-kernel-build.out" 2> "$tmp/project-ribon-kernel-build.err"
contains "$tmp/project-ribon-kernel-build.out" "status ok"
test -f "$tmp/project-ribon/.qstar/out/___kernel/kernel.elf" || fail "ribon kernel artifact missing"
contains "$tmp/project-ribon/.qstar/logs/___kernel_compile_0.log" "boot/start.S"
contains "$tmp/project-ribon/.qstar/logs/___kernel_compile_1.log" "src/kernel.c"
contains "$tmp/project-ribon/.qstar/logs/___kernel_link_0.log" "-T linker/rpi5-aarch64.ld"
contains "$tmp/project-ribon/.qstar/logs/___kernel_link_0.log" "--defsym=__rpi_load_addr=0x80000"
"$qstar" --file "$tmp/project-ribon/qstar.lua" build //:kernel_img --explain-cache > "$tmp/project-ribon-img-build.out" 2> "$tmp/project-ribon-img-build.err"
contains "$tmp/project-ribon-img-build.out" "build_generated_action //:kernel_img"
contains "$tmp/project-ribon-img-build.out" "output_identity=[generated/kernel8.img|group=images|format=raw-binary|address=0x80000|layout=rpi5-kernel8]"
contains "$tmp/project-ribon-img-build.out" "status ok"
test -f "$tmp/project-ribon/generated/kernel8.img" || fail "ribon raw image missing"
contains "$tmp/project-ribon/generated/kernel8.img" "RAW-BINARY"
"$qstar" --file "$tmp/project-ribon/qstar.lua" build //:kernel_img --explain-cache > "$tmp/project-ribon-img-skip.out" 2> "$tmp/project-ribon-img-skip.err"
contains "$tmp/project-ribon-img-skip.out" "build_action id=//:kernel_img:generate:0 status=skip"
printf "kernel-drift\n" >> "$tmp/project-ribon/.qstar/out/___kernel/kernel.elf"
"$qstar" --file "$tmp/project-ribon/qstar.lua" build //:kernel_img --explain-cache > "$tmp/project-ribon-img-rebuild.out" 2> "$tmp/project-ribon-img-rebuild.err"
contains "$tmp/project-ribon-img-rebuild.out" "cache_miss id=//:kernel_img:generate:0 reason=input-changed"
"$qstar" --file "$tmp/project-ribon/qstar.lua" stage //:rpi --dry-run > "$tmp/project-ribon-rpi-dry.out" 2> "$tmp/project-ribon-rpi-dry.err"
contains "$tmp/project-ribon-rpi-dry.out" "stage_file src=.qstar/out/___kernel/kernel.elf dst=stage/rpi/kernel.elf mode=dry-run"
contains "$tmp/project-ribon-rpi-dry.out" "stage_file src=generated/kernel8.img dst=stage/rpi/kernel8.img mode=dry-run"
"$qstar" --file "$tmp/project-ribon/qstar.lua" stage //:rpi > "$tmp/project-ribon-rpi-stage.out" 2> "$tmp/project-ribon-rpi-stage.err"
contains "$tmp/project-ribon-rpi-stage.out" "stage_file src=boot/config.txt dst=stage/rpi/config.txt mode=copy"
contains "$tmp/project-ribon-rpi-stage.out" "stage_file src=.qstar/out/___kernel/kernel.elf dst=stage/rpi/kernel.elf mode=copy"
contains "$tmp/project-ribon-rpi-stage.out" "stage_file src=generated/kernel8.img dst=stage/rpi/kernel8.img mode=copy"
test -f "$tmp/project-ribon/stage/rpi/config.txt" || fail "ribon staged config missing"
test -f "$tmp/project-ribon/stage/rpi/kernel.elf" || fail "ribon staged kernel elf missing"
test -f "$tmp/project-ribon/stage/rpi/kernel8.img" || fail "ribon staged kernel image missing"
contains "$tmp/project-ribon/.qstar/stage/___rpi/manifest.json" "\"dst\":\"stage/rpi/kernel8.img\""
"$qstar" --file "$tmp/project-ribon/qstar.lua" build //:qemu_smoke > "$tmp/project-ribon-qemu.out" 2> "$tmp/project-ribon-qemu.err"
contains "$tmp/project-ribon-qemu.out" "run_target label=//:qemu_smoke"
contains "$tmp/project-ribon-qemu.out" "run_marker label=//:qemu_smoke status=matched marker=RIBON-SMOKE-DONE source=marker_log path=serial.log"
contains "$tmp/project-ribon/serial.log" "RIBON-SMOKE-DONE"
"$qstar" --file "$tmp/project-ribon/qstar.lua" --profile uefi-x64 dry-run //:uefi_boot > "$tmp/project-ribon-uefi-dry.out" 2> "$tmp/project-ribon-uefi-dry.err"
contains "$tmp/project-ribon-uefi-dry.out" "response_style=msvc"
contains "$tmp/project-ribon-uefi-dry.out" "/out:.qstar/out/___uefi_boot/BOOTX64.EFI"
contains "$tmp/project-ribon-uefi-dry.out" "/subsystem:efi_application"
"$qstar" --file "$tmp/project-ribon/qstar.lua" --profile uefi-x64 build //:uefi_boot > "$tmp/project-ribon-uefi-build.out" 2> "$tmp/project-ribon-uefi-build.err"
contains "$tmp/project-ribon-uefi-build.out" "status ok"
test -f "$tmp/project-ribon/.qstar/out/___uefi_boot/BOOTX64.EFI" || fail "ribon UEFI artifact missing"
contains "$tmp/project-ribon/.qstar/logs/___uefi_boot_link_0.log" "/entry:efi_main"
"$qstar" --file "$tmp/project-ribon/qstar.lua" --profile uefi-aa64 dry-run //:uefi_boot > "$tmp/project-ribon-uefi-aa64-dry.out" 2> "$tmp/project-ribon-uefi-aa64-dry.err"
contains "$tmp/project-ribon-uefi-aa64-dry.out" "/out:.qstar/out/___uefi_boot/BOOTAA64.EFI"
"$qstar" --file "$tmp/project-ribon/qstar.lua" --profile uefi-x64 stage //:esp --dry-run > "$tmp/project-ribon-esp-dry.out" 2> "$tmp/project-ribon-esp-dry.err"
contains "$tmp/project-ribon-esp-dry.out" "stage_file src=.qstar/out/___uefi_boot/BOOTX64.EFI dst=stage/esp/EFI/BOOT/BOOTX64.EFI mode=dry-run"
...
contains "../docs/qstar/qstar-v0.1-hardening-seal.md" "qstar/tests/projects/ribon-bootloader-like"
