...
contains "README.md" "Stella/Ninja medium performance line protocol artifacts"
contains "README.md" "Candidate tarball dry-run plus Stella/Ninja medium perf artifacts through Ubuntu gcc/clang CI"
...
contains "README.ko.md" "Stella/Ninja medium performance line protocol artifact"
...
contains "docs/qstar-v0.5-readiness.md" "0.5.2-beta.1"
...
contains "docs/public-beta-release.md" "0.5.2-beta.1"
...
contains "docs/releases/v0.5.2-beta.1.md" "documented beta opt-in"
contains "docs/releases/v0.5.2-beta.1.md" "qstar daemon --query"
contains "docs/releases/v0.5.2-beta.1.md" "Windows named pipe support is deferred"
...
contains "wiki/reference/stella-daemon.md" "documented beta opt-in candidate"
contains "wiki/reference/stella-daemon.md" "0.5.2-beta.1"
