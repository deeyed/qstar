...
9. Execute build/test/stage/install through the effective generator boundary.

QStar keeps commands shell-free. All external commands are `qstar.cli { ... }`
argv vectors. Stage/install copy and manifest work remain QStar-owned even when
artifact production is delegated to Ninja.
