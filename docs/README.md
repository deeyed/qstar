...
- `configurable-build-surface.md`: Korean current-surface reference for
  ...
  `qstar.subdir` without domain-specific builtin fields. It also records the
  Stella/Ninja/explain/dry-run/action-log/replay/compile_commands/query parity
  contract for objectlib and GLP object actions.
...
- `../wiki/reference/configurable-build-surface.md`: user-facing Korean
  reference mirror for the current configurable build surface.
...
- `releases/v0.7.17-beta.md`: previous public beta patch release note.
- `releases/v0.7.16-beta.md`: previous public beta patch release note.
- `releases/v0.7.15-beta.md`: previous public beta patch release note.
- `releases/v0.7.14-beta.md`: previous public beta patch release note.
- `releases/v0.7.13-beta.md`: previous public beta patch release note.
- `releases/v0.7.12-beta.md`: previous public beta patch release note.
