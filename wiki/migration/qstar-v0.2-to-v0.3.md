...
QStar는 C/C++/ASM을 잘 지원하지만 특정 언어에 종속되지 않는 빌드시스템이다. v0.2는
authoring hard cut 이후의 current surface이고, v0.3은 package/artifact-style
...
v0.3 후보는 package resolver, richer provider model, sharedlib executor, tool policy
