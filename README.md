...
`v0.4.0-beta.1`, with macOS arm64 binaries published first. Linux and Windows
support are planned, and QStar 1.0 is reserved for a release that is validated
