...
| Windows | MSYS2 UCRT64 기반 validation-backed beta candidate, `v0.7.19-beta` release-backed evidence 보유, Actions에서 `windows-x86_64` public beta candidate zip 생성/추출 smoke와 GitHub Release publish/download smoke 가능 |
