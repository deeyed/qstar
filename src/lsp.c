...
static const struct qstar_lsp_hover_entry qstar_lsp_fields[] = {
	...
	{ "type", "Provider option type: string, bool, list, or enum." },
	{ "values", "Allowed string values for a provider enum option." },
	{ "default", "Default metadata for a provider option schema." },
