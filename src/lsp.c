...
static const struct qstar_lsp_hover_entry qstar_lsp_symbols[] = {
	...
	{ "qstar.step.run", "Project command step that executes a command-local argv-vector action." },
...
static const struct qstar_lsp_hover_entry qstar_lsp_fields[] = {
	...
	{ "expect", "run_target expectation table with contains and optional file." },
	{ "contains", "Expected text for run_target checks under expect.contains." },
	{ "file", "Optional package-relative file scanned by run_target expect.file." },
	...
	{ "working_dir", "Package-relative default working directory reserved for command run steps." },
